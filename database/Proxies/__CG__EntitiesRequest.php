...
class Request extends \Entities\Request implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Entities\\Request' . "\0" . 'nonce', '' . "\0" . 'Entities\\Request' . "\0" . 'protocol', '' . "\0" . 'Entities\\Request' . "\0" . 'created', '' . "\0" . 'Entities\\Request' . "\0" . 'started', '' . "\0" . 'Entities\\Request' . "\0" . 'completed', '' . "\0" . 'Entities\\Request' . "\0" . 'id', '' . "\0" . 'Entities\\Request' . "\0" . 'network'];
        }
